...
Our study adds to a small but growing body of work quantifying the demographic mechanisms giving rise to skewed operational sex ratios along environmental gradients \citep{gonzalez2019sex,bialic2020deer,santidrian2020temperature}, %,eberhart2017sex,veran2009demographic,shelton2010origin
...
Geographic variation in OSR may be an instructive proxy for how the dioecious species whose population growth rate is most sensitive to sex ratio will respond to climate change \citep{petry2016sex}. The link between OSR and responses to climate adds value to studies of the causes and consequences of spatial variation in sex ratio, particularly at geographic scales that encompass ``past'' and ``future'' conditions. 
