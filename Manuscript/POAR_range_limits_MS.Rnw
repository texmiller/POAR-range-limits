...
\title{Two-sex demography, sexual niche differentiation, and range limits}
...
Returning to the question of whose niche determines range limits given potential for sexual niche differentiation, classic ecological theory provides a straightforward answer. 
