...
Sex differences in flowering and panicle production generated a longitudinal trend in the operational sex ratio of our common garden populations that mirrored the trend in natural populations: the fraction of total panicles that were female in our common gardens increased from west to east (Fig. \ref{fig:garden_sex_ratios}A) even as the fraction of surviving plants that were female did not show a longitudinal trend (Fig. \ref{fig:garden_sex_ratios}B).
Thus, the common garden experiment suggested that the longitudinal trend in the mating pool of natural populations (Fig. \ref{fig:survey}) was due to the reproductive niche of females extending farther east than that of males, and not to sex differences in mortality.
...
The overall decline in $\lambda$ was driven most strongly by the decline in female flowering probability at the western limit and by a combination of reduced female flowering and growth at the eastern limit (Fig. \ref{fig:lambda_long}B). 
