...
There was a female survival advantage but only at the western range edge for large sizes. 
...
Finally, panicle production by flowering plants was similar between the sexes for most sizes, though for the largest sizes there were modest advantages for males in the west and females in the east (Fig. \ref{fig:vital_rates}J-L). 
The sex differences in reproductive vital rates generated a longitudinal trend in the operational sex ratio of our common garden populations that mirrored the trend in natural populations, with over-representation of female panicles increasing toward eastern range limits.
Thus, the common garden experiment indicated that the reproductive niche of females extended farther east than that of males. 

\subsection*{Sex-ratio dependent seed fertilization}

Seed fertilitzation by females declined with increasing female bias in experimental populations. 
