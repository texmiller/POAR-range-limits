...
Collectively, these results suggest that the small size distribution of the common garden experiment led to a weaker role of males than would be expected in populations with a more realistic size distribution, but that even with a larger size distribution, declines in female performance still dominant range boundary formation.
...
\begin{figure}[H]
  ...
  \caption{Results for elevated growth model, in which the intercept of growth function was increased by a factor of 2.75.
