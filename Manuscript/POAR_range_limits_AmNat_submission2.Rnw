...
\revise{\linelabel{mismatchresults}For survival, flowering, and panicle production we did not find strong evidence for local adaptation based on the posterior distributions of the climate mismatch coefficient (Fig. \ref{fig:climate_mismatch}A,C,D). 
However, climate mismatch negatively affected growth such that plants from populations whose mean annual precipitation strongly differed from that of the common garden location exhibited reduced growth (Fig. \ref{fig:climate_mismatch}B). }
...
Two anonymous reviewers helped us improve our manuscript. 
